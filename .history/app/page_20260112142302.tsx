...
const themes = [
  { id: 1, name: "Super Saver Packages", tours: "20+", image: "/popular-tourist-destinations-colorful-city.jpg" },
  { id: 2, name: "Winter Tours", tours: "70+", image: "/snow-mountains-winter-resort-skiing.jpg" },
  { id: 3, name: "Group Tours", tours: "110+", image: "/group-of-tourists-famous-landmarks.jpg" },
  { id: 4, name: "Maharaj Tours", tours: "15+", image: "/luxury-travel-indian-chef-cooking.jpg" },
  { id: 5, name: "Honeymoon Packages", tours: "60+", image: "/romantic-couple-beach-sunset-honeymoon.jpg" },
  { id: 6, name: "Short Breaks", tours: "20+", image: "/weekend-getaway-quick-vacation.jpg" },
  { id: 7, name: "Exotic Tours", tours: "15+", image: "/exotic_tours.jpg" },
  { id: 8, name: "Self-Drive Tours", tours: "5+", image: "/self_drive_tours.jpg" },
]

// Dummy Data for Destinations
const destinations = [
  { name: "USA", desc: "Big cities, national parks & theme parks", price: "1,50,000", image: "/usa_travel.jpg" },
  { name: "Dubai", desc: "Desert safaris, modern attractions & luxury", price: "45,000", image: "/blog-dubai.png" },
  { name: "Japan", desc: "Cherry blossoms, culture & technology", price: "2,00,000", image: "/blog-japan.png" },
  { name: "Thailand", desc: "Island escapes, nightlife & city vibes", price: "30,000", image: "/southeast-asia-beaches-and-temples.jpg" },
  { name: "Singapore & Malaysia", desc: "Two countries, one seamless experience", price: "65,000", image: "/singapore-cruise-ship-universal-studios.jpg" },
  { name: "Europe", desc: "Switzerland, France, Italy & more", price: "2,50,000", image: "/blog-europe.png" },
  { name: "Bali", desc: "Tropical beaches, culture & relaxation", price: "40,000", image: "/romantic-couple-beach-sunset-honeymoon.jpg" },
  { name: "Australia", desc: "Wildlife, cities & adventure combined", price: "1,80,000", image: "/australia_travel.jpg" },
  { name: "New Zealand", desc: "Nature, scenic beauty & peaceful escapes", price: "2,20,000", image: "/new-zealand-mountains-and-lakes-milford-sound.jpg" },
]
              ...
              <CarouselContent className="-ml-4">
                {themes.map((theme) => (
                  <CarouselItem key={theme.id} className="pl-4 md:basis-1/2 lg:basis-1/4">
                    <div className="p-1">
                      <Card className="overflow-hidden border-none shadow-lg group hover:shadow-2xl transition-all duration-300 rounded-3xl">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative h-[400px] lg:h-[600px] rounded-[2rem] overflow-hidden shadow-2xl order-2 lg:order-1">
               <Image
                src="/placeholder.svg" // Replace with relevant company image
             ...
             <div className="text-center mb-16">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                      ...
                      <div key={i} className="group relative h-48 md:h-64 rounded-3xl overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-300">
                           <Image
                            src="/placeholder.svg"
                            alt={style}
                            fill
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-6">
                              <span className="text-white font-bold text-xl md:text-2xl leading-tight block">{style}</span>
