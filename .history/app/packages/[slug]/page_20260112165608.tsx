        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Tabs defaultValue="overview" className="w-full">
              <div className="sticky top-[70px] z-30 bg-[#f6f8fa] pt-2 pb-2 -mx-4 px-4 md:mx-0 md:px-0">
                 <TabsList className="w-full justify-start h-auto p-1.5 bg-white border border-gray-100 shadow-lg shadow-black/5 rounded-xl gap-1 flex-nowrap overflow-x-auto min-w-max md:min-w-0 no-scrollbar">
                    {[
                      ...
                      { id: "info", label: "Tour Info", icon: HelpCircle },
                       ...
                       <TabsTrigger 
                        key={tab.id} 
                        value={tab.id}
                        className="data-[state=active]:bg-[#0B3C5D] data-[state=active]:text-white data-[state=active]:shadow-md px-4 py-2.5 rounded-lg gap-2 text-[#4A5568] font-semibold text-sm transition-all whitespace-nowrap"
                       >
                         {tab.label}
                       </TabsTrigger>
                    ))}
              ...
              {/* Tab: Overview */}
              <TabsContent value="overview" className="space-y-6 animate-in fade-in slide-in-from-bottom-4 mt-6">
                 <div className="bg-white border border-gray-100 rounded-xl p-8 shadow-sm">
                    <h3 className="text-2xl font-bold text-[#0B3C5D] mb-4 font-serif">Trip Overview</h3>
                    <p className="text-[#1A1A1A] leading-relaxed text-base tracking-wide">
                       {pkg.description}
                    </p>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-[100px] space-y-6 z-20">
               <Card className="border-0 shadow-2xl rounded-2xl overflow-hidden ring-1 ring-black/5">
                  ...
                  {/* Sidebar Form Area (Navy Background Extension) */}
