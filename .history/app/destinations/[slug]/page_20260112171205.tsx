      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 p-4 md:hidden shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xl font-bold text-[#0B3C5D]">₹ {destination.priceFrom.toLocaleString("en-IN")}</p>
          </div>
          <Link href="/packages" className="flex-1">
            <Button className="w-full bg-[#FF7A00] hover:bg-[#e65100] text-white font-bold rounded-full shadow-md">
              View Packages
            </Button>
          </Link>
        </div>
